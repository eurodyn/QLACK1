...
public class CustomJDBCMetaDataDialect extends JDBCMetaDataDialect {
  ...
  public static HashMap<String, HashMap> tablesStructure = new HashMap<String, HashMap>();
  public static HashMap<String, String> tablesPKs = new HashMap<String, String>();
